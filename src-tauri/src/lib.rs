...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex::get_active_codex_account,
            commands::codex::add_codex_account_from_file,
            commands::codex::switch_codex_account,
            commands::codex::delete_codex_account,
            commands::codex::rename_codex_account_cmd,
            commands::codex::get_codex_usage,
            commands::codex::refresh_codex_account,
            commands::codex::refresh_all_codex_accounts_usage,
            commands::codex::start_codex_oauth,
            commands::codex::start_codex_oauth_and_wait,
